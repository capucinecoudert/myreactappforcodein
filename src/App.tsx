  ...
  render() {
    return (
      <div className="App">
        ...
        <p className="title">Steppenwolf from Herman HESSE</p>
        <p className="texte"> Steppenwolf from Herman Hesse is one of my favorite novel.
